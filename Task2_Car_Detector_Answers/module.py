...
class ObjectDetector(pl.LightningModule):
    def __init__(self, save_imgs=False):
        ...
        # Basic Hardcoded Parameters
        self.learning_rate = 1e-3  # This can be changed
        ...
        no_classes = 2  # For CE Loss
        # no_classes = 1  # For difference loss
    ...
    def training_step(self, batch, batch_idx):
        ...
        annotation = torch.squeeze(annotation) # Removes excess dimension (for CE loss)
        ...
        # loss = nn.MSELoss()(annotation, prediction)
        # loss = nn.L1Loss()(annotation, prediction)
        # print(loss)
    ...
    def validation_step(self, batch, batch_idx):
        ...
        # Metric (Idea: How many cars captured)
    ...
    def process_batch(self, batch):
        ...
        centers_tensor = torch.stack(centers).type(torch.LongTensor) #Note: alot of machine learning is processing/manipulating data (for CE loss)
